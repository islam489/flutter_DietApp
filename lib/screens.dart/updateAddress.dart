...
class UpdateAdresses extends StatefulWidget {
  static final route = 'update';

  @override
  _UpdateAdressesState createState() => _UpdateAdressesState();
}

class _UpdateAdressesState extends State<UpdateAdresses> {
  String _myActivity;
  ...
  ResponseAddressData addressData;
  ...
  void didChangeDependencies() {
    if(!isFirst)return;
    isFirst=false;
    addressData = ModalRoute.of(context).settings.arguments;
    governorateController.text = '${addressData.governorateCode}';
    blockController.text = '${addressData?.plotCode}';
    areaController.text = '${addressData?.areaCode}';
    avenueController.text = '${addressData?.avenueCode}';
    streetController.text = '${addressData?.street}';
    houseNoController.text = '${addressData?.buildingNo}';
    floorNoController.text = '${addressData?.floorNo}';
    apartNoController.text = '${addressData?.apartmentNo}';
    notesController.text = '${addressData?.notes}';
                                          ...
                                          return DropdownMenuItem<String>(
                                            ...
                                            onTap: () {
                                              ...
                                              governorateController.text =
                                                  ...
                                                  print('governorate=>>>>>>>>>>>>' + governorate.govId.toString());

                                              setState(() {
                                                areas.clear();
                                                areas.addAll(governorate.areas);
                                              });
                                            },
                                          );
                                        }).toList(),
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    if (_formKey.currentState.validate()) {
                                      ...
                                      data = await API.updateNewAddress(
                                        governorateController.text,
                                        areaController.text,
